 ...
 */
public class AmazonRecyclerViewAdapter extends RecyclerView.Adapter<AmazonRecyclerViewAdapter.DataObjectHolder> {
    ...
    public AmazonRecyclerViewAdapter(List<Product> myDataset, Context context) {
        mDataset = myDataset;
        this.context = context;
    }

    @Override
    public AmazonRecyclerViewAdapter.DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
