 ...
 */
public class FlipkartRecyclerViewAdapter extends RecyclerView.Adapter<FlipkartRecyclerViewAdapter.DataObjectHolder> {
    ...
    public FlipkartRecyclerViewAdapter(List<Product> myDataset, Context  context) {
        mDataset = myDataset;
        this.context = context;
    }

    @Override
    public FlipkartRecyclerViewAdapter.DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
