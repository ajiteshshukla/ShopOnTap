 ...
 */
public class AmazonAffiliateCategory implements IfaceAffiliateCategory{

    public Category category;

    public List<Product> products = new ArrayList<Product>();

    public AmazonAffiliateCategory(Category category) {
    ...
    public String createFetchProductListUrl(String categoryName) {
        ...
        return (AppConstants.REQUEST_URL + "?requesttype=" + AppConstants.REQUEST_PRODUCTS
                + "&affiliate=" + AppConstants.AFFILIATE_AMAZON + "&category=" + categoryName);
    }
